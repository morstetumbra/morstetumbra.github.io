<header class="main-header">
  ...
  <a href="#" class="logo">
    ...
    <span class="logo-mini"><b>B</b>FM</span>
    <!-- logo for regular state and mobile devices -->
    <span class="logo-lg"><b>BENESERE FARMA</b></span>
  </a>
        ...
        <li class="dropdown user user-menu">
          ...
          <ul class="dropdown-menu">
            ...
            <li class="user-footer">
              <div class="pull-left">
                <a href="#profile" data-toggle="modal" class="btn btn-default btn-flat" id="admin_profile">Actualizacion</a>
              </div>
