...
class TCPDF_STATIC {
	...
	* @since 5.9.121 (2011-09-28)
	 ...
	 * @param $haystack (string) The string to  in.
	 * @param $needle (string) substring to .
	 * @param $offset (int) May be specified to begin ing an arbitrary number of characters into the string.
...
// ====================================================================================================================
	 ...
	 * @param $pattern (string) The regular expression pattern to  for without the modifiers, as a string.
